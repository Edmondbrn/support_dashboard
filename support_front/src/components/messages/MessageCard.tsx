...
const MessageCard = memo((props : MessageCardProps) => {
    ...
    const badgePosition = profile?.username === props.senderName ? "-top-3 -right-1" : "-translate-x-5 -translate-y-4";
    const initials = profile?.username === props.senderName ? getUserInitials(profile) : initialsFromUsername(props.senderName);
